...
<body class="min-h-screen flex flex-col font-body-md antialiased">
    <!-- TopNavBar (Nav shell suppressed for transactional page, but keeping a simplified brand header) -->
    <header
        class="w-full py-6 px-margin-mobile md:px-margin-desktop flex justify-center items-center fixed top-0 z-50 bg-background/80 backdrop-blur-md">
                ...
                <div class="mt-8 text-center border-t border-outline-variant/30 pt-6">
                    <p class="font-body-sm text-body-sm text-on-surface-variant">
                        ...
                        <a class="text-primary font-medium hover:text-primary-fixed-variant transition-colors underline underline-offset-4 decoration-primary/30 hover:decoration-primary"
                            href="/login.html">Inicia sesión</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <footer
        ...
        <p class="font-body-sm text-body-sm text-on-surface-variant">© 2024 Accesorios Yamileth. All rights reserved.
        </p>
    </footer>
</body>
