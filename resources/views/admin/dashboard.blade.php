...
<body class="bg-[#FFF8F8] text-[#201A1D]" style="font-family: Inter, sans-serif;">
            ...
            <section class="mb-6 rounded-xl border border-red-200 bg-red-50 p-5">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p class="text-sm text-red-700">Hay productos con menos de {{ $lowStockThreshold }} unidades en
                            stock.</p>
                    </div>
                    <a href="{{ route('admin.inventario.index') }}"
                        class="w-fit rounded-full bg-red-600 px-4 py-2 text-sm font-bold text-white hover:bg-red-700">Revisar
                        inventario</a>
                </div>
    ...
    <section     class="mt-8 grid gap-6 lg:grid-cols-2">
          <div cla  ss="rounded-xl bg-white p-6 shadow-sm">
            <div class="mb-4 flex items-center justify-between">
            ...
            <div class="space-y-4">
                ...
                <a href="{{ route('admin.analitica') }}" class="rounded-lg border border-[#8A486F]/20 bg-[#FDF0F4] p-4 font-semibold text-[#8A486F] hover:bg-[#f9dce8]">Ver analítica</a>
                    ...
                    <a href="{{ route('admin.pedidos.index') }}" class="rounded-lg border border-[#8A486F]/20 bg-[#FDF0F4] p-4 font-semibold text-[#8A48
   6            F] hover:bg-[#f9dce8]">Revisar pedidos</a>
                </div>
            </div>
    </s
ection>
